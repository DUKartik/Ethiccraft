...
const ENDPOINTS = {
  LOGIN: `${API_BASE_URL}/index.php?route=login`,
  GET_EVENTS: `${API_BASE_URL}/index.php?route=events`,
  VERIFY_TICKET: `${API_BASE_URL}/index.php?route=verify`,
  GET_ATTENDEES: `${API_BASE_URL}/index.php?route=attendees`
};
